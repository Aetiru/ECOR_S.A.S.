...
<form class="text-center border border-light p-5" action="" name="form" method="post" onsubmit="return validaDatos(this);" id="form" value="1">
    ...
    <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4">
          Al menos 8 caracteres y 1 d&iacute;gito
    </small>
    <button class="btn btn-info my-4 btn-block" name="button" type="submit" >Ingresar</button>
    <p>&iquest;Aun no te haz registrado?</p>
    <a href="registro.php">&iexcl;Registrate!</a>
